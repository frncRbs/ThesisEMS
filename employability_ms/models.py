...
class UserSchema(marsh.Schema):
    class Meta:
        fields = ('id', 'first_name', 'middle_name', 'last_name', 'contact_number', 'email', 'desired_career', 'department', 'password', 'is_approve', 'user_type')
...
class User(db.Model, UserMixin):
    ...
    def __init__(self, first_name, middle_name, last_name, contact_number, email, desired_career, department, password, is_approve, user_type):

...
def signupCS():
    try:
        new_user = User(request.form['first_name'], request.form['middle_name'], request.form['last_name'], request.form['contact_number'], request.form['email'], request.form['desired_career'],  'computer science', (generate_password_hash(request.form['password'], method="sha256")), False, 1)
